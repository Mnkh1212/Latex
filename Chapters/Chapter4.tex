...
\begin{itemize}
    \item \textbf{Алхам бүрд том дугуй дүрс} (хэтэвч, диаграм, холбоосын дүрс) гол санааг визуал хэлбэрээр илэрхийлнэ.
    \item \textbf{Гарчиг ба тайлбар} --- хэрэглэгчид програмын зорилгыг товчоор тайлбарлана.
...
\begin{itemize}
    ...
    \item \textbf{Дансны хайрцагнууд.} Хэрэглэгчийн бүх банкны данс зэрэгцэн харагдана. Дарвал тухайн данс идэвхтэй болж бүх тоо, диаграм шинэчлэгдэнэ.
...
\begin{itemize}
    ...
    \item \textbf{Дүн оруулах талбар.} Том төгрөгийн тэмдэгтэй тоон оролт. Хэрэглэгч гар утасны цифр гарнаас оруулна.
...
Шинжилгээ дэлгэц нь хоёр горимтой: \textbf{Статистик} (тоон үзүүлэлт + багана график) болон \textbf{Диаграм} (гөлгөр муруй). Хэрэглэгч өдөр, 7 хоног, сар, жил гэсэн хугацааны шүүлтүүр сонгож харах боломжтой.
...
\textbf{Гол элементүүд:}
\begin{itemize}
    \item \textbf{Дээд таб.} \emph{Статистик} ба \emph{Диаграм} гэсэн хоёр горимыг солих.
    \item \textbf{Хугацааны шүүлтүүр.} \emph{Өдөр}, \emph{7 хоног}, \emph{Сар}, \emph{Жил} гэсэн 4 сонголтын шүүлтүүр. Сонгогдсон сонголт ногоон тодорсон төлвөөр харагдана.
...
\section{Шинжилгээ дэлгэц --- диаграм горим}
Диаграм горим нь орлого, зарлагын чиг хандлагыг \emph{гөлгөр муруй} хэлбэрээр харуулна. Энэ нь нэгэн харахад чиг хандлагыг ойлгоход тохиромжтой.
...
\end{subfigure}
\caption{Диаграм горим --- орлого, зарлагын чиг хандлагын муруй}
...
AI зөвлөмжийн картанд тоон үндэслэлтэй дугаарлагдсан зөвлөмж 4-6 эгнээ багтдаг. Жишээ нь "Таны 2026 оны 1-3 сард нийт зарлага 7{,}698{,}944 төг нь нийт орлого 7{,}491{,}834 төг-өөс 207{,}110 төг-өөр давсан байна" гэх мэт хатуу тоонд тулгуурласан санал гаргадаг.
...
Хэрэглэгч сар бүр байнга төлдөг тогтмол төлбөрөө (Netflix, утасны төлбөр, зээлийн эргэн төлөлт гэх мэт) урьдчилан тохируулах боломжтой. Дэлгэц нь хоосон төлвөөс эхлэн \texttt{+} товчлуурын тусламжтайгаар нэмэгддэг.

\begin{figure}[H]
\centering
\includegraphics[width=0.36\textwidth]{Figures/screen_scheduled_empty.png}
\caption{Давтагдах төлбөр --- хоосон төлвийн харагдац}
\label{fig:scheduled-empty}
\end{figure}

\textbf{Гол элементүүд:}
\begin{itemize}
    \item \textbf{Хоосон төлвийн дүрс.} Хоёр сум эргэлт хийсэн дугуй дүрс, доор нь "Төлөвлөсөн төлбөр байхгүй" гэсэн заавар.
...
\textbf{Ар талын логик.} \texttt{GET /api/v1/scheduled-payments} хариу нь хоосон жагсаалт буцаахад UI хоосон төлвийг харуулна. Шинэ төлбөр нэмэхэд \texttt{POST /api/v1/scheduled-payments} руу \texttt{frequency} (daily, weekly, monthly, yearly), \texttt{next\_date} зэрэг талбарууд илгээгдэнэ.
...
Хоосон төлвийн заавар   & Өгөгдөл байхгүй үед \texttt{+ нэмэх} үйлдэлд уриалах товчоор хэрэглэгчийг чиглүүлдэг. \\ \hline
...
Банкны хуулгын AI шинжилгээний (FR-10) нарийвчлалыг үнэлэхийн тулд 3 банкны (ХХБ, Голомт, Хаан) нийт \textbf{30 бодит хуулгыг} (банк бүрт 10) гар утсаар оруулж туршив. Туршилтын метрик нь NLP-ийн стандарт үзүүлэлт болох \emph{precision}, \emph{recall}, \emph{F1-score} ба гүйлгээний задралын алдааны түвшин:
...
\begin{itemize}
    ...
    \item \textbf{График томруулах.} Диаграм горимд хэрэглэгч график дээр товшоход тоон утгыг харуулдаггүй.
