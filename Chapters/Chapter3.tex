...
\node[note] at (12, -8.7) {AI давхарга: Gemini (анхдагч) fail (geo-block / 429 / 5xx) \\ $\Rightarrow$ OpenRouter руу автомат нөөц шилжилт};
...
\textbf{Тайлбар.} Хар шулуун шугам нь хүсэлт (request), цэгтэй ногоон шугам нь хариулт (response). Шар хайрцагт AI давхрагын дотоод нөөц шилжилтийн зарчмыг тусгайлан тэмдэглэв --- хэрэглэгч талд энэ үйл явц харагдахгүй, зөвхөн backend дотор шийдэгдэнэ. Хэрэглэгч талаас гарсан \emph{нэг} POST хүсэлт нь backend дотор \textbf{4 өөр үйлчилгээ} (MinIO, Parser, AI, DB)-тэй харьцаж 11 дотоод дуудлага хийгдээд эцэст нь \emph{нэг} JSON хариулт болж буцна.
