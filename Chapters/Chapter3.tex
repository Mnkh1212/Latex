...
\caption{Sequence Diagram (Дарааллын диаграм) --- Банкны хуулгын AI шинжилгээ}
\label{fig:seq-analysis}
\end{figure}

\textbf{Тайлбар.} Хар цул шугам нь хүсэлт (request), тасархай ногоон шугам нь хариулт (response). Шар хайрцагт AI давхрагын дотоод нөөц шилжилтийн зарчмыг тусгайлан тэмдэглэв --- хэрэглэгч талд энэ үйл явц харагдахгүй, зөвхөн сервер тал дотор шийдэгдэнэ. Хэрэглэгч талаас гарсан \emph{нэг} POST хүсэлт нь сервер тал дотор \textbf{4 өөр үйлчилгээ} (MinIO, Parser, AI, DB)-тэй харьцаж 11 дотоод дуудлага хийгдээд эцэст нь \emph{нэг} JSON хариулт болж буцна.
...
\textbf{Дүгнэлт.} Энэ бүлэгт системийн архитектур, сервер талын кодын зохион байгуулалт, загваруудын class диаграм, өгөгдлийн сангийн ER загвар, MinIO объект хадгалалтын дизайн, REST API цэгүүд, AI шинжилгээний долоон алхамт урсгал, хоёр дарааллын диаграм (AI чат болон банкны хуулгын шинжилгээ), гүйлгээ нэмэх үйл ажиллагааны диаграм, хэрэглэгч талын дэлгэц, аюулгүй байдлын механизм болон хэрэгжүүлэлтийн тоон үзүүлэлтийг танилцууллаа. Дараагийн хэсэгт дипломын ажлын нэгдсэн дүгнэлт, цаашдын хөгжүүлэлтийн чиглэлийг авч үзнэ.
