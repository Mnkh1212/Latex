...
\node[data] (d) at (-3.2, 1) {%
    ...
    \scriptsize PostgreSQL 16 (port 5433) \\
    \scriptsize GORM v1.25.9 $\cdot$ 11 хүснэгт
};
...
\begin{enumerate}
    ...
    \item \textbf{Файл хадгалах.} Сервер файлыг \texttt{./uploads/statements/statement\_<userID>\_<unix>.<ext>} нэрээр хадгална. Файлын нэр давхардахаас сэргийлж Unix цагийн тэмдэглэгээг дугаар болгон ашигладаг.
...
\draw[msg] (6,-2.4) -- node[above]{сүүлийн 30 хоногийн Tx} (9,-2.4);
...
\node[section, fill=accentteal!20, minimum height=1.2cm] at (5, 1.0) {AI: Сүүлийн 30 хоногт \\ food, transport ангилалд...};
...
\textbf{docker-compose.yml} нь 2 үйлчилгээг зэрэг ажиллуулна: \texttt{postgres} (port 5433 → 5432) ба \texttt{backend} (port 8080). Сервер талын Dockerfile нь олон шатлалт бүтээлттэй:
\begin{enumerate}
...
\texttt{backend}  & \texttt{./backend}-ээс бүтээх  & port 8080, depends\_on postgres. \\ \hline
\end{tabular}
...
Docker контейнер                  & 2 (postgres + сервер тал) \\ \hline
